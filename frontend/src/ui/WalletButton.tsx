...
export function WalletButton() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="sm:hidden absolute right-0 top-full mt-2 w-56 rounded-xl bg-zinc-950/95 backdrop-blur-md border border-arena-gold/30 shadow-2xl shadow-black/50 p-3 z-50">
          <div className="text-[10px] uppercase tracking-widest text-white/45 font-bold">
            Wallet
          </div>
          ...
          <div className="text-base font-mono text-arena-gold font-bold mb-3">
            {parenaBalance}{' '}
            <span className="text-[10px] text-arena-gold/60">PARENA</span>
          </div>
          <button
